...
#            LIBS += -L$$BOOSTDIR/lib -lboost_date_time-xgcc40-mt-1_42 -lboost_thread-xgcc40-mt-1_42
    ...
    isEmpty(OGREDIR) {
        ...
        CONFIG(release, debug|release) {
            LIBS += -L../lib/release -L$$OGREDIR/lib/release -L$$OGREDIR/lib/release/opt -lOgreMain -lRenderSystem_GL
        } else {
            LIBS += -L../lib/debug -L$$OGREDIR/lib/debug -L$$OGREDIR/lib/debug/opt -lOgreMain_d -lRenderSystem_GL_d
        }
        LIBS += -L$$OGREDIR/lib -L$$OGREDIR/lib/OGRE
    }
}
